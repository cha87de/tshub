...
type GetHostOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.HostDetails `json:"body,omitempty"`
}
...
func (o *GetHostOK) WithPayload(payload *models.HostDetails) *GetHostOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get host o k response
func (o *GetHostOK) SetPayload(payload *models.HostDetails) {
	o.Payload = payload
}
...
/*GetHostNotFound Element not found
